...
part 'itemDTOReceive.g.dart';

@JsonSerializable(explicitToJson: true)
class ItemDTOReceive extends Equatable{
  const ItemDTOReceive( {
  ...
  factory ItemDTOReceive.fromJson(Map<String, dynamic> json) =>
      _$ItemFromJson(json);

  Map<String, dynamic> toJson() => _$ItemToJson(this);

  ItemDTOReceive copyWth({
    String? userId,
    String? id,
    String? title,
    double? pricePerUnit,
