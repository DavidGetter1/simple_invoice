...
class ModifyItemScreen extends StatelessWidget {
  const ModifyItemScreen({Key? key, required this.item}) : super(key: key);
                ...
                child: Column(
                  children: [
                    InputField(
                      title: 'Title',
                      controller:
                          context.read<ItemModifyCubit>().titleController,
                      validator: (value) =>
                          context.read<ItemModifyCubit>().validateTitle(value),
                    ),
                    const Divider(
                      thickness: 1,
                    ),
                    InputField(
                      title: 'Price',
                      controller:
                          context.read<ItemModifyCubit>().priceController,
